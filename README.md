...
- [Shor's Algorithm](https://quantum.cloud.ibm.com/learning/en/modules/computer-science/shors-algorithm): Context for the broader significance of quantum advantage, demonstrating exponential speedup over classical methods for integer factorisation.
- [Grover's Algorithm](https://quantum.cloud.ibm.com/learning/en/courses/fundamentals-of-quantum-algorithms/grover-algorithm/introduction): Further context for quantum speedup, providing a quadratic improvement over classical search that applies to a much wider class of problems than Deutsch–Jozsa.